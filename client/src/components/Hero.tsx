    ...
    return (
        <section
            ...
            <div className='flex gap-2'>
                <a href="#projects" onMouseEnter={handleHoverOn} onMouseLeave={handleHoverOff} className='hero-item border border-green-400 text-green-400 hover:bg-green-400 hover:text-black p-4'>VIEW PROJECTS</a>
                <a href="#contact" onMouseEnter={handleHoverOn} onMouseLeave={handleHoverOff} className='hero-item border border-gray-600 text-gray-600 hover:border-white hover:text-white  p-4'>GET IN TOUCH</a>
            </div>
        </section>
    )
}
